...
const AwardCard = ({ award }) => {
  ...
  {/* image section  70% */}
  <div className="h-[70%] w-full overflow-hidden bg-black">
    <img
      src={award.image}
      alt={award.title}
  ...
  {/* info section 30% */}
  <CardContent className="flex flex-col items-center justify-center text-center py-2 flex-1 w-full bg-[#12171c]">
