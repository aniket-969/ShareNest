...
const itemVariants = cva(
  'group/item [a&]-accent/50 focus-visible-ring focus-visible-ring/50 flex flex-wrap items-center rounded-md border border-transparent text-sm outline-none transition-colors duration-100 focus-visible-[3px] [a&]-colors',
  {
    variants: {
      variant: {
...
const itemMediaVariants = cva(
  'flex shrink-0 items-center justify-center gap-2 group-has-[[data-slot=item-description]]/item-y-0.5 group-has-[[data-slot=item-description]]/item-start [&_svg]-events-none',
  {
    variants: {
      variant: {
        default: 'bg-transparent',
        icon: "bg-muted size-8 rounded-sm border [&_svg([class*='size-'])]-4",
        image:
          'size-10 overflow-hidden rounded-sm [&_img]-full [&_img]-cover',
      },
    },
    defaultVariants: {
      variant: 'default',
